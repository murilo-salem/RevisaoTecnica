...
**Data:** 11/06/2026 10:42:44
**Busca:** `carbon dioxide`
**Total de patentes encontradas:** 9
**Modelo de avaliação:** qwen3:8b
...
|---|---|---:|---:|---|
| setup | degraded | 1.05s | 1 | Verificação do modelo Ollama |
| search | ok | 36.39s | 9 | 9 patentes únicas após dedupe |
...
- **Latência média:** 1.05s
- **Latência máxima:** 1.05s
...
- **GooglePatents**: bruto=9, duração=28.03s, diagnósticos=nenhum
- **Patentscope**: bruto=0, duração=8.35s, diagnósticos=blocked_or_captcha=1, discovery_empty=1, jsf_empty_results=1
...
- **Modelo LLM:** qwen3:8b
- **Data de geração:** 11/06/2026 10:42:44
- **Query de busca:** `carbon dioxide`
- **Status da execução:** completed
- **Tempo total:** 37.5s
- **LLM disponível:** não
- **Fila de revisão manual:** 9 itens
- **Snapshot hash:** `429b4a02c18c5d2b22522a98aec6b208c9e796c4a264ea00e1704f02dd60a59b`
